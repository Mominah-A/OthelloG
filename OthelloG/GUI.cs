namespace OthelloG
{
	...
	public partial class GUI : Form
	{
		...
		private void Button_Click(object sender, EventArgs e)
		{
			...
			{
				// if the move is valid then make the palyer move and update the grid and shift the control to other player.
				...
				// Show the message if the game is over and start a new game
		...
		// Update the turn of player to indicate which player is currently playing
		...
		// Reinitialize the game board and set the new game
		...
		// Show the game message to display the winner and end of game
		...
		{
			// Update the statistics at the bottom information panel
