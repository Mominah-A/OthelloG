...
namespace OthelloG
{
	public class GameboardImageArray : UserControl
	{
		...
		private Control _containingForm;
		...
		public GameboardImageArray(Control parentForm, int[,] gameBoardStateArray, Point topCorner,
		...
		private void RenderGameStateToGui(Control parentForm, int[,] gameStateArray)
		{
			for (int r = 0; r < _boardRows; r++)
			{
				for (int c = 0; c < _boardCols; c++)
